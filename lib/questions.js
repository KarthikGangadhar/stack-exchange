...
module.exports = class Question extends stackExchange {
    ...
    answers_on_questions(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "ANSWERS_ON_QUESTIONS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    linked_questions(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "LIKED_QUESTIONS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    related_questions(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "RELATED_QUESTIONS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    questions_timeline(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "QUESTIONS_TIMELINE");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    featured_questions(options = {}, callback) {
        let url = helper.getEndpoint(options, "FEATURED_QUESTIONS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    no_answer_questions(options = {}, callback) {
        let url = helper.getEndpoint(options, "NO_ANSWER_QUESTIONS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    unanswered_questions(options = {}, callback) {
        let url = helper.getEndpoint(options, "UNANSWERED_QUESTIONS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    unanswered_questions_my_tags(options = {}, callback) {
        let url = helper.getEndpoint(options, "UNANSWERED_QUESTIONS_BY_MY_TAGS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    render_answer(id, body, callback) {
        let url = helper.getEndpoint({}, "RENDER_ANSWER");
    ...
    question_flag_options(id, options, callback) {
        let url = helper.getEndpoint(options, "QUESTION_FLAG_OPTIONS");
        let formated_url = util.format(url, id);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    question_close_options(id, options, callback) {
        let url = helper.getEndpoint(options, "QUESTION_CLOSE_OPTIONS");
        let formated_url = util.format(url, id);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    comments_on_questions(id, options, callback) {
        let url = helper.getEndpoint(options, "COMMENTS_ON_QUESTIONS");
        let formated_url = util.format(url, id);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
