...
module.exports = class Tags extends stackExchange {
    ...
    tags_by_name(name, options = {}, callback) {
        let url = helper.getEndpoint(options, "TAGS_BY_NAME");
    ...
    require_tags(options = {}, callback) {
        let url = helper.getEndpoint(options, "REQUIRE_TAGS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    tag_synonyms(options = {}, callback) {
        let url = helper.getEndpoint(options, "TAG_SYNONYMS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    faqs_by_tags(tag, options = {}, callback) {
        let url = helper.getEndpoint(options, "FAQS_BY_TAGS");
    ...
    related_tags(tag, options = {}, callback) {
        let url = helper.getEndpoint(options, "RELATED_TAGS");
        let formated_url = util.format(url, tag);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    synonyms_by_tags(tag, options = {}, callback) {
        let url = helper.getEndpoint(options, "SYNONYMS_BY_TAGS");
        let formated_url = util.format(url, tag);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    top_answerers_on_tags(tag, options = {}, callback) {
        let url = helper.getEndpoint(options, "TOP_ANSWERS_ON_TAGS");
    ...
    top_askers_on_tags(tag, options = {}, callback) {
        let url = helper.getEndpoint(options, "TOP_ASKERS_ON_TAGS");
        let formated_url = util.format(url, tag, options.period);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    wikis_by_tags(tag, options = {}, callback) {
        let url = helper.getEndpoint(options, "WIKIS_BY_TAGS");
        let formated_url = util.format(url, tag);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    moderator_only_tags(options = {}, callback) {
        let url = helper.getEndpoint(options, "MODERATORS_ONLY_TAGS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
