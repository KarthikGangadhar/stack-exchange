...
module.exports = class Users extends stackExchange {
    ...
    user_notifications(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "USER_NOTIFICATIONS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    posts_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "POSTS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    privileges_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "PRIVILEGES_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    questions_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "QUESTIONS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    featured_questions_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "FEATURED_QUESTIONS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    no_answer_questions_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "NO_ANSWER_QUESTIONS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    unaccepted_questions_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "UNACCEPTED_QUESTIONS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    unanswered_questions_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "UNANSWERED_QUESTIONS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    reputation_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "REPUTATION_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    reputation_history(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "REPUTATION_HISTORY");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    full_reputation_history(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "FULL_REPUTATION_HISTORY");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    suggested_edits_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "SUGGESTED_EDITS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    tags_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "TAGS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    top_user_answers_in_tags(ids, tags, options = {}, callback) {
        let url = helper.getEndpoint(options, "TOP_USER_ANSWERS_IN_TAGS");
    ...
    top_user_questions_in_tags(ids, tags, options = {}, callback) {
        let url = helper.getEndpoint(options, "TOP_USER_QUESTIONS_IN_TAGS");
        let formated_url = util.format(url, ids, tags);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    timeline_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "TIMELINE_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    top_answer_tags_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "TOP_ANSWER_TAGS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    top_question_tags_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "TOP_QUESTION_TAGS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    top_tags_on_users(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "TOP_TAGS_ON_USERS");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    moderators(options = {}, callback) {
        let url = helper.getEndpoint(options, "MODERATORS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    elected_moderators(options = {}, callback) {
        let url = helper.getEndpoint(options, "ELECTED_MODERATORS");
        helper.getResponse(url).then((response) => {
            callback(response);
        }).catch((err) => {
            callback({
    ...
    user_inbox(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "USER_INBOX");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    user_unread_inbox(ids, options = {}, callback) {
        let url = helper.getEndpoint(options, "USER_UNREAD_INBOX");
        let formated_url = util.format(url, ids);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
    ...
    associated_users(id, options = {}, callback) {
        let url = helper.getEndpoint(options, "ASSOCIATED_USERS");
    ...
    merge_history(id, options = {}, callback) {
        let url = helper.getEndpoint(options, "MERGE_HISTORY");
        let formated_url = util.format(url, id);
        helper.getResponse(formated_url).then((response) => {
            callback(response);
        }).catch((err) => {
